...
import { FaInbox, FaCreditCard } from "react-icons/fa6";
...
const DraftSidebar = () => {
  return (
    <aside className="fixed left-0 top-0 z-40 h-screen w-64 -translate-x-full border-r border-gray-200 bg-white px-4 py-8 pt-24 transition-transform dark:border-gray-700 dark:bg-gray-800 sm:translate-x-0">
